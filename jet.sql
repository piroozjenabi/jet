...
CREATE TABLE `jet_auto_auto_refer_user` (
  ...
  PRIMARY KEY (`id`),
  KEY `tbl_auto_refer_user_tbl_user_admin_id_fk` (`user_id`),
  ...
  CONSTRAINT `tbl_auto_refer_user_tbl_user_admin_id_fk` FOREIGN KEY (`user_id`) REFERENCES `jet_user_admin` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `jet_auto_forms` (
  ...
  KEY `tbl_auto_forms_tbl_user_admin_id_fk` (`maker_id`),
  ...
  CONSTRAINT `tbl_auto_forms_tbl_user_admin_id_fk` FOREIGN KEY (`maker_id`) REFERENCES `jet_user_admin` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `jet_crm_Promoter` (
  ...
  CONSTRAINT `tbl_promoter_tbl_user_admin_id_fk` FOREIGN KEY (`maker_id`) REFERENCES `jet_user_admin` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `jet_crm_Promoter_track` (
  ...
  PRIMARY KEY (`id`),
  KEY `tbl_promotor_track_tbl_user_admin_id_fk` (`user_id`),
  ...
  CONSTRAINT `tbl_promotor_track_tbl_user_admin_id_fk` FOREIGN KEY (`user_id`) REFERENCES `jet_user_admin` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `jet_log` (
  ...
  KEY `user_id` (`user_id`),
  KEY `ip` (`ip`)
) ENGINE=InnoDB AUTO_INCREMENT=433 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='log system';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_auto_forms_value` (
  ...
  KEY `tbl_auto_forms_value_tbl_user_admin_id_fk` (`maker_id`),
  ...
  CONSTRAINT `tbl_auto_forms_value_tbl_user_admin_id_fk` FOREIGN KEY (`maker_id`) REFERENCES `jet_user_admin` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_mali_bed_bes_group` VALUES (1,'صدور فاکتور',1,0,'user'),(2,'پرداخت فاکتور',0,1,'user'),(3,'کمیسیون کارمندان',0,1,'user_admin'),(4,'واریز کارمندان',1,0,'user_admin'),(7,'حقوق',0,1,'user_admin'),(8,'دریافت چک مشتری',0,1,'user'),(9,'پرداخت مشتری',0,1,'user');
...
-- Dump completed on 2021-03-30 23:06:50
