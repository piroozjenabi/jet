...
INSERT INTO `jet_factor_prd` VALUES (17,'[1]',13,16,'0','100',NULL,1),(18,'[1]',13,17,'10','150',NULL,5),(19,'[1]',14,18,'0','200',NULL,1),(20,'[1]',15,19,'0','300',NULL,1),(21,'[1]',15,20,'0','300',NULL,1),(22,'[1]',14,21,'100','200',NULL,2),(23,'[1]',14,22,'0','200',NULL,2),(24,'[1]',14,23,'0','200',NULL,1),(25,'[2]',13,23,'0','200',NULL,5),(26,'[1]',13,24,'0','100',NULL,1);
...
CREATE TABLE `jet_log` (
  ...
  KEY `user_id` (`user_id`),
  KEY `ip` (`ip`)
) ENGINE=InnoDB AUTO_INCREMENT=180 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='log system';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='manage media ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `jet_media` VALUES (1,'007d76650162bab5bf9b308d4a6dcb5a.jpg',NULL,NULL,'0',0,0,1,16,'2021-03-30 20:34:11','test');
...
-- Dump completed on 2021-03-31  3:47:51
