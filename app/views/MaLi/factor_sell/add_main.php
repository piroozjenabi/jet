...
?>
<style type="text/css"> input{direction: ltr !important;} .h1ads{display: none} </style>
<h2 class='page-header'> <?=_ADD_FACTOR?>
...
<table id="prd_tbl"  class="table table-striped table-bordered" >
  <tr style="background-color: #1f1f1f;color: #ffffee;text-align: center" >
    ...
    <td><?php echo $takhfif_prd ?><div id="perfix_takhfif"> </div></td>
...
<script type="text/javascript">
  //get row number 
  var _row=getrow();
  function getrow() { _row=0; do{ _row++ } while(document.getElementById('radif['+_row +']')); _row--; return _row; }
  ...
  function calcAdditionls(tot){
    $('.aplus').each(function(e,i){ tot+=parseInt($(this).val()) });
    $('.amines').each(function(e,i){ tot-=parseInt($(this).val()) });
    return tot;
  }
