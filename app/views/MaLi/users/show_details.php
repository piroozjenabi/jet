...
<?php foreach ($levelsar as $k => $v) : ?>
    <div data-toggle="collapse" data-target="#<?php echo $v["id"] ?>" style="text-align: center" class="btn btn-default">
        <h3> <?php echo _LIST . $v["des"] ?> </h3>
    </div>
