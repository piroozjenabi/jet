...
echo form_open('CRM/Report_system_log');
...
?>
    <h3 class="panel-heading"> <?php echo _LIST_REPORT_SYSTEM ?> </h3>
    <div class="row  well modal-body ">
    <div class="col-sm-3 "><label for="type"><?php echo _NAME." "._USER ?></label><?php echo $user ?></div>
    <div class="col-sm-3 "><label for="type"><?php echo _DATE." "._START ?></label><?php echo $date_start ?><?php echo $date_hidden_start ?></div>
    <div class="col-sm-3 "><label for="type"><?php echo _DATE." "._END ?></label><?php echo $date_end ?><?php echo $date_hidden_end ?></div>
    <div class="col-sm-3 " style="padding:20px;"><?php echo $savebtn ?></div>
<?php form_close() ?>
<?php echo $table_list ?>
