...
$fani_number= form_input(array('value'=> $detail_prd[0]["fani_number"],'id'=>'fani_number', 'placeholder' => _FANI_NUMBER,'name' => 'fani_number','class'=>$def_css_class));
...
$pic= form_input(array('value'=> $detail_prd[0]["pic"],'id'=>'pic', 'placeholder' => _PIC,'name' => 'pic','class'=>$def_css_class));
$file= form_input(array('value'=> $detail_prd[0]["file"],'id'=>'file', 'placeholder' => _FILE,'name' => 'file','class'=>$def_css_class));
$url= form_input(array('value'=> $detail_prd[0]["url"],'id'=>'url', 'placeholder' => _URL,'name' => 'url','class'=>$def_css_class));
...
<div class="row well">
  ...
  <div class="col-sm-4 "><label for="name"><?php echo _NAME." "._PRD ?></label><?php echo $name ?></div>
  ...
  <div class="col-sm-4 "><label for="fani_number"><?php echo _FANI_NUMBER ?></label><?php echo $fani_number ?></div>
...
<div class="row well">
  <h3> <?= _ADVANCED_SETTING ?> </h3>
   ...
   <div class="col-sm-3 "><label for="pic"><?php echo _PIC ?></label><?php echo $pic ?></div>
   <div class="col-sm-3 "><label for="file"><?php echo _FILE ?></label><?php echo $file ?></div>
   <div class="col-sm-6 "><label for="url"><?php echo _URL ?></label><?php echo $url ?></div>
</div>
<?php if($this->system->get_setting('enable_prd_pricing')): ?>
<div class="row well">
  <h3> <?= _PRICE_SETTING ?> </h3>
  <div class="col-sm-2 "><label for="price1"><?php echo _PRICE."1" ?></label><?php echo $price1 ?></div>
  <div class="col-sm-2 "><label for="price2"><?php echo _PRICE."2" ?></label><?php echo $price2 ?></div>
  <div class="col-sm-2 "><label for="price3"><?php echo _PRICE."3" ?></label><?php echo $price3 ?></div>
  <div class="col-sm-2 "><label for="price4"><?php echo _PRICE."4" ?></label><?php echo $price4 ?></div>
